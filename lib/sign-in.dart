...
//Just a snackbar. To remove once the validation of the login page is done.
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar: new AppBar(
        bottomOpacity: 0.7,
       title: new Text("The Talking Pigeon",style: TextStyle(
         fontFamily: 'aileron',
         fontSize: 25.0,
         //letterSpacing: 1.0,
 ...
 void _submit(){
  ...
  List<String> people = [];
   check() async{
    var temp ;
    people = [];
    DocumentReference documentReference2 = Firestore.instance.document("People/People");
    ...
    temp = null;
      ...
      print(people);
      await documentReference2.setData(peopledata).whenComplete(()
  ...
  void performsignup() async{
    print("hello");
    final DocumentReference documentReference = Firestore.instance.document("Users/${userData.uid}");
    ...
    try{
      ...
      Timer(Duration(milliseconds: 400), ()=>Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>ChatScreen(username: userData.uid,))));
    }
    catch(e)
    {
      progress = 0;
  ...
  Widget build(BuildContext context) {
        return new ListView(
                shrinkWrap: true,
                    ...
                    new Text("Your details ?",style: new TextStyle(
                        color: Colors.white,
                        fontSize: 22.0,
                        fontFamily: 'beauty',
                        letterSpacing: 3.0,
                        ...
                        child: new Container(
                            ...
                            child: new Column(
                              ...
                              children: <Widget>[
                                ...
                                progress !=1?Container():CircularProgressIndicator(strokeWidth: 5.0,),
                                new Padding(
                                  padding: const EdgeInsets.all(20.0),
                                ),
                          ],
 ...
 void _submit(){
  ...
  await documentReference.get().then((snapshot){
    ...
    try{
     ...
     Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>ChatScreen(username: userData.uid,))));
    }
    }
    catch(e)
    {
  ...
  Widget build(BuildContext context) {
        return new ListView(
                shrinkWrap: true,
                    ...
                    new Text("Log in and continue...",style: new TextStyle(
                      color: Colors.white,
                      fontSize: 22.0,
                      //fontWeight: FontWeight.bold,
                      fontFamily: 'beauty',
                    ...
                    new Form(
                      ...
                      child: new Theme(
                        ...
                        child: new Container(
                            ...
                            child: new Column(
                              ...
                              children: <Widget>[
                                new TextFormField(
                                  ...
                                  validator: (val)=>val.isEmpty || val.substring(0)==null?'User Name field is empty':null,
                                  keyboardType: TextInputType.text,
                                  onSaved: (val)=> userData.uid = val,
                            ),
                            new TextFormField(
                            ...
                            new RaisedButton(
                              onPressed: (){_submit();_playAnimation();},
                              padding: EdgeInsets.symmetric(horizontal: buttonSqueezeAnimation.value,vertical: 10.0),
                              child: buttonSqueezeAnimation.value > 40.0 ? new Text(
                                      "Sign In",
                                        style: new TextStyle(
                                        color: Colors.white,
